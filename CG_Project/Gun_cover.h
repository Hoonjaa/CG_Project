...
private:
    ...
    GLvoid setVertexInfo() {
        GLfloat temp[9 * 24] = {
            ...
            vPos.x + 0.06f, vPos.y + 0.11f, vPos.z + 0.15f,  vColor.r, vColor.g, vColor.b,  0.0f, 0.0f, 1.0f,
            vPos.x - 0.06f, vPos.y + 0.11f, vPos.z + 0.15f,  vColor.r, vColor.g, vColor.b,  0.0f, 0.0f, 1.0f,
            vPos.x - 0.06f, vPos.y - 0.11f, vPos.z + 0.15f,  vColor.r, vColor.g, vColor.b,  0.0f, 0.0f, 1.0f,
            vPos.x + 0.06f, vPos.y - 0.11f, vPos.z + 0.15f,  vColor.r, vColor.g, vColor.b,  0.0f, 0.0f, 1.0f,

            // ¿ÞÂÊ¸é (x = -0.5, normal = -1, 0, 0)
            vPos.x - 0.06f, vPos.y + 0.11f, vPos.z + 0.15f,  vColor.r, vColor.g, vColor.b,  -1.0f, 0.0f, 0.0f,
            vPos.x - 0.06f, vPos.y + 0.11f, vPos.z - 0.15f,  vColor.r, vColor.g, vColor.b,  -1.0f, 0.0f, 0.0f,
            vPos.x - 0.06f, vPos.y - 0.11f, vPos.z - 0.15f,  vColor.r, vColor.g, vColor.b,  -1.0f, 0.0f, 0.0f,
            vPos.x - 0.06f, vPos.y - 0.11f, vPos.z + 0.15f,  vColor.r, vColor.g, vColor.b,  -1.0f, 0.0f, 0.0f,
            ...
            vPos.x + 0.06f, vPos.y + 0.11f, vPos.z - 0.15f,  vColor.r, vColor.g, vColor.b,  0.0f, 1.0f, 0.0f,
            vPos.x - 0.06f, vPos.y + 0.11f, vPos.z - 0.15f,  vColor.r, vColor.g, vColor.b,  0.0f, 1.0f, 0.0f,
            vPos.x - 0.06f, vPos.y + 0.11f, vPos.z + 0.15f,  vColor.r, vColor.g, vColor.b,  0.0f, 1.0f, 0.0f,
            vPos.x + 0.06f, vPos.y + 0.11f, vPos.z + 0.15f,  vColor.r, vColor.g, vColor.b,  0.0f, 1.0f, 0.0f,
