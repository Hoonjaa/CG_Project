...
{
	vColor = glm::vec3(0.7f, 0.7f, 0.7f);
	setVertexInfo();
	// VBO: 정점 데이터
...
GLvoid Gun_barrel::draw(const GLuint& ShaderID, const glm::mat4& worldMatrix, const glm::mat4& viewProjMatrix)
{
