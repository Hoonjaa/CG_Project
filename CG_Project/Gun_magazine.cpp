...
{
	vColor = glm::vec3(0.3f, 0.3f, 0.3f);
	setVertexInfo();
	// VBO: 정점 데이터
...
GLvoid Gun_magazine::draw(const GLuint& ShaderID, const glm::mat4& worldMatrix, const glm::mat4& viewProjMatrix)
{
