...
private:
    ...
    GLvoid setVertexInfo() {
        ...
        vPos.x + 0.05f, vPos.y + 0.1f, vPos.z + 0.5f,  vColor.r, vColor.g, vColor.b,  0.0f, 0.0f, 1.0f,
        vPos.x - 0.05f, vPos.y + 0.1f, vPos.z + 0.5f,  vColor.r, vColor.g, vColor.b,  0.0f, 0.0f, 1.0f,
        vPos.x - 0.05f, vPos.y - 0.1f, vPos.z + 0.5f,  vColor.r, vColor.g, vColor.b,  0.0f, 0.0f, 1.0f,
        vPos.x + 0.05f, vPos.y - 0.1f, vPos.z + 0.5f,  vColor.r, vColor.g, vColor.b,  0.0f, 0.0f, 1.0f,

        // ¿ÞÂÊ¸é (x = -0.5, normal = -1, 0, 0)
        vPos.x - 0.05f, vPos.y + 0.1f, vPos.z + 0.5f,  vColor.r, vColor.g, vColor.b,  -1.0f, 0.0f, 0.0f,
        vPos.x - 0.05f, vPos.y + 0.1f, vPos.z - 0.5f,  vColor.r, vColor.g, vColor.b,  -1.0f, 0.0f, 0.0f,
        vPos.x - 0.05f, vPos.y - 0.1f, vPos.z - 0.5f,  vColor.r, vColor.g, vColor.b,  -1.0f, 0.0f, 0.0f,
        vPos.x - 0.05f, vPos.y - 0.1f, vPos.z + 0.5f,  vColor.r, vColor.g, vColor.b,  -1.0f, 0.0f, 0.0f,
        ...
        vPos.x + 0.05f, vPos.y + 0.1f, vPos.z - 0.5f,  vColor.r, vColor.g, vColor.b,  0.0f, 1.0f, 0.0f,
        vPos.x - 0.05f, vPos.y + 0.1f, vPos.z - 0.5f,  vColor.r, vColor.g, vColor.b,  0.0f, 1.0f, 0.0f,
        vPos.x - 0.05f, vPos.y + 0.1f, vPos.z + 0.5f,  vColor.r, vColor.g, vColor.b,  0.0f, 1.0f, 0.0f,
        vPos.x + 0.05f, vPos.y + 0.1f, vPos.z + 0.5f,  vColor.r, vColor.g, vColor.b,  0.0f, 1.0f, 0.0f,
